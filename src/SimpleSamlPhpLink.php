...
class SimpleSamlPhpLink {
  ...
  /**
   * Value is 'TRUE' if was simpleSAMLphp session when this property was set.
   *
   * @var bool
   */
   ...
   *
   * @throws \Drupal\simplesamlphp_auth\Exception\SimpleSamlPhpInternalConfigException
